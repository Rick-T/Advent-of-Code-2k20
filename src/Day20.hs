...
-- 8272903687921
part1 :: IO Int
part1 = withInput "Day20.txt" (readInput $ parseBest imagesP) solvePart1

-- >>> part2
-- 2304
part2 :: IO Int
part2 = withInput "Day20.txt" (readInput $ parseBest imagesP) solvePart2
...
imageP = do
  ...
  _ <- char ':'
  _ <- newline
  lines <- some tileP `sepEndBy` newline
  return (i, parseGrid lines)
